...
export const validatePermitCreation = [
  ...
  body('contractor.name').notEmpty().withMessage('Contractor name is required')
];
...
export const validateAreaCreation = [
  ...
  body('hazardLevel').isIn(['low', 'medium', 'high', 'critical'])
    .withMessage('Invalid hazard level')
];
...
export const validateUserCreation = [
  ...
  body('role').isIn(['platform_owner', 'company_owner', 'plant_head', 'safety_incharge', 'hod', 'contractor', 'worker'])
...
export const validateUserUpdate = [
  ...
  body('role').optional().isIn(['platform_owner', 'company_owner', 'plant_head', 'safety_incharge', 'hod', 'contractor', 'worker'])
    .withMessage('Invalid role'),
  body('plantId').optional().isMongoId().withMessage('Valid plant ID is required')
];
